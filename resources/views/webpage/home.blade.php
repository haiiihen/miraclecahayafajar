        ...
        <div id="header-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel">
            <div class="carousel-inner">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <a href="#" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn mr-2">Shop Now</a>
                                        <div style="width: 20px;"></div>
                                        <a href="#" class="btn btn-light rounded-pill py-3 px-5 animated zoomIn ml-2">Explore More</a>
                                    </div>
                                    <!-- End of buttons -->
                ...
                <div class="carousel-item">
                    <img class="w-100" src="{{ asset('webpage/img/carousel-2.jpg') }}" alt="Image">
                    <div class="carousel-caption">
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-7 text-center">
        ...
        <div class="container py-5">
            ...
            <div class="owl-carousel product-carousel wow fadeInUp" data-wow-delay="0.5s">
                <a href="" class="d-block product-item rounded">
                    <img src="{{ asset('webpage/img/product-1.jpg') }}" alt="">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{ asset('webpage/img/product-2.jpg') }}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{ asset('webpage/img/product-3.jpg') }}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
                ...
                <a href="" class="d-block product-item rounded">
                    <img src="{{ asset('webpage/img/product-4.jpg') }}" alt="">
                    <div class="bg-white shadow-sm text-center p-4 position-relative mt-n5 mx-4">
        ...
        <div class="container">
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="{{ asset('webpage/img/store-product-2.jpg') }}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                    <div class="store-item position-relative text-center">
                        <img class="img-fluid" src="{{ asset('webpage/img/store-product-3.jpg') }}" alt="">
                        <div class="p-4">
                            <div class="text-center mb-3">
                                <small class="fa fa-star text-primary"></small>
                                <small class="fa fa-star text-primary"></small>
                ...
                <div class="container py-5">
                    <div class="row g-4">
                        <div class="col-md-6 col-lg-3">
                            <div style="background-color: #9abf69 !important;" class="featurs-item text-center rounded bg-light p-4">
